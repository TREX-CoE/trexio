...
*** Gaussian-type and Slater-type orbitals
  ...
  \[
  g_{ks}(\mathbf{r}) = ||\mathbf{r} - \mathbf{R}_A||^{\ell_s} \exp(-\gamma_{ks} ||\mathbf{r} - \mathbf{R}_A||^2),
  \]
...
# these values correspond to normalization of the full primitive basis functions
# in the TREXIO spherical convention (regular solid harmonics)
    #+END_EXAMPLE

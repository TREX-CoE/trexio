...
h_code = [ """#+begin_src c :tangle prefix_front.h : exports none
#define TREXIO_POS (+1)
#define TREXIO_NEG (-1)
"""
]
...
for k,v in perms.items():
    ...
    name = "trexio_%d_index_%d_perm%s"%(n,m,anti)
    c_code += [ """
static int32_t NAME__[DIM] = {
};
const int32_t* NAME() { return &(NAME__[0]) };
"""
                .replace("NAME",name) 
...
const int32_t* trexio_2_index_1_perm();
const int32_t* trexio_2_index_2_perm();
const int32_t* trexio_2_index_2_perm_anti();
const int32_t* trexio_3_index_1_perm();
const int32_t* trexio_3_index_2_perm();
const int32_t* trexio_3_index_2_perm_anti();
const int32_t* trexio_3_index_3_perm();
const int32_t* trexio_4_index_4_perm_anti();
const int32_t* trexio_4_index_1_perm();
const int32_t* trexio_4_index_4_perm();
const int32_t* trexio_4_index_4_perm_anti();
const int32_t* trexio_4_index_4_perm();
const int32_t* trexio_4_index_4_perm_anti();
 #+end_src
...
static int32_t trexio_2_index_1_perm__[3] = {
};
const int32_t* trexio_2_index_1_perm() { return &(trexio_2_index_1_perm__[0]) };


static int32_t trexio_2_index_2_perm__[6] = {
};
const int32_t* trexio_2_index_2_perm() { return &(trexio_2_index_2_perm__[0]) };


static int32_t trexio_2_index_2_perm_anti__[6] = {
};
const int32_t* trexio_2_index_2_perm_anti() { return &(trexio_2_index_2_perm_anti__[0]) };


static int32_t trexio_3_index_1_perm__[4] = {
};
const int32_t* trexio_3_index_1_perm() { return &(trexio_3_index_1_perm__[0]) };


static int32_t trexio_3_index_2_perm__[8] = {
};
const int32_t* trexio_3_index_2_perm() { return &(trexio_3_index_2_perm__[0]) };


static int32_t trexio_3_index_2_perm_anti__[8] = {
};
const int32_t* trexio_3_index_2_perm_anti() { return &(trexio_3_index_2_perm_anti__[0]) };


static int32_t trexio_3_index_3_perm__[12] = {
};
const int32_t* trexio_3_index_3_perm() { return &(trexio_3_index_3_perm__[0]) };


static int32_t trexio_4_index_4_perm_anti__[20] = {
};
const int32_t* trexio_4_index_4_perm_anti() { return &(trexio_4_index_4_perm_anti__[0]) };


static int32_t trexio_4_index_1_perm__[5] = {
};
const int32_t* trexio_4_index_1_perm() { return &(trexio_4_index_1_perm__[0]) };


static int32_t trexio_4_index_4_perm__[20] = {
};
const int32_t* trexio_4_index_4_perm() { return &(trexio_4_index_4_perm__[0]) };
